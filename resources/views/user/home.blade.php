            ...
            @foreach ($banchay as $item)
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <h3>{{ $item->tensach }}</h3>
                        <h6><span class="price">{{number_format($item->gia)}}</span> / <a href="#">Buy Now</a></h6>
                        <div class="hover">
                            <a href="{{url('product/detail')}}/{{$item->masach}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        ...
                        <h3><a href="#">{{$item->tensach}}</a></h3>
                        <h6>Khuyến mãi<span class="price">{{$item->khuyenmai}}%</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                @endforeach
            </div>
