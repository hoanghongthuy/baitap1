...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 01, 2020 lúc 09:15 AM
...
CREATE TABLE `sach` (
  ...
  `gia` int(10) NOT NULL,
  `khuyenmai` int(10) NOT NULL DEFAULT 0 COMMENT '%gia khuyen mai (tu 1->100)',
  `hinh` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `manxb` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `maloai` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sachmoi` int(1) NOT NULL DEFAULT 0 COMMENT 'sachmoi=1',
  `banchay` int(1) NOT NULL DEFAULT 0 COMMENT 'banchay=1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
